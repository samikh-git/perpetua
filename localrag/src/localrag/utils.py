...
def load_env():
    ...
    if os.path.exists(HOME_DIR + "/localrag/.env"):
        load_dotenv(HOME_DIR + "/localrag/.env")
    else:
        raise FileNotFoundError("Project has not been configured. Please set run `localrag config`")
